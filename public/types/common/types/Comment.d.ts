...
export declare type ServiceType = 'youtube' | 'twicas' | 'twitch' | 'niconama' | 'showroom' | 'bilibili';
export declare type CommentDataType = YouTube.CommentResponse | Twicas.CommentResponse | Twitch.CommentResponse | NicoNama.CommentResponse;
...
export declare type Comment = YouTubeComment | TwicasComment | TwitchComment | NicoNamaComment | ShowroomComment | BiliBiliComment;
